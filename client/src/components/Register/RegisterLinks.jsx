...
export default function RegisterLinks({setPages, user, setUser}) {
    ...
    const [socialLinksURL, setSocialLinksURL] = useState([]);
    ...
    function goNext(){
        ...
        linksURL.forEach((item, index) => {
            if(item != undefined)
            {
                platformArr.push(socialPlatforms[index]);
                linkArr.push(item)
            }
        })
        setLinksURL(linkArr);
    ...
    function updateURL(e, index) {
        ...
        const result = [...linksURL];
        result[index] = e.target.value;
        setLinksURL(result)
        let linkObj = {}
        linkObj[socialPlatforms[index]] = result
        const arr = [linkObj]
        console.log("linkObj, arr")
        setSocialLinksURL([...socialLinksURL, arr])
    }
                                            ...
                                            <div id={`${index}`} className='flex flex-row w-full pr-2 gap-1 mb-0'>
                                                ...
                                                { 
                                                    ...
                                                    <div className="avatar pr-2 pt-1">
                                                        <div className="w-10 h-10  rounded ring ring-neutral ring-offset-base-100">
                                                            <img
                                                    ...
                                                    :
                                                    <div className='btn btn-ghost border-warning hover:border-warning w-12 h-12'>
                                        ...
                                        socialPlatforms.map((elementInArray, index) => (
                                            <div id={`${index}`} className='flex flex-row w-full pr-2 gap-1 mb-0'>
                                                ...
                                                }
                                                {
                                                    ...
                                                    <input className='input input-ghost input-bordered border-warning focus:bg-transparent focus:border-warning focus:text-white text-white w-64' placeholder='Phone Number' value={linksURL[index]} onChange={(e) => updateURL(e, index)}></input>

                                                    :

                                                    elementInArray === 'Email' ?

                                                    <input className='input input-ghost input-bordered border-warning focus:bg-transparent focus:border-warning focus:text-white text-white w-64' placeholder='Email Address' value={linksURL[index]} onChange={(e) => updateURL(e, index)}></input>
 
                                                    :

                                                    <input className='input input-ghost input-bordered border-warning focus:bg-transparent focus:border-warning focus:text-white text-white w-64' placeholder='Link URL' value={linksURL[index]} onChange={(e) => updateURL(e, index)}></input>
